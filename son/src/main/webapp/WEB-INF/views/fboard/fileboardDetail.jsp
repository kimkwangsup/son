...
<c:forEach var="IMG" items="${LIST}">
				...
				<div class="w3-col">
					...
					<pre class="w3-rest w3-left-align pdl10" id="body">11
...
<c:if test="${not empty DATA }">
		...
		<div class="w3-third w3-btn w3-section w3-pale-blue w3-ripple" id="list">글목록</div>
		<div class="w3-third w3-btn w3-section w3-pale-red w3-ripple" id="edit">글수정</div>
</c:if>
<c:if test="${empty DATA or empty SID or (SID ne DATA.id)}">
		<div class="w3-half w3-btn w3-section w3-pale-green w3-ripple" id="home">HOME</div>
